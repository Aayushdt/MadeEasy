...
export default function Header({ theme, onToggleTheme }) {
  return (
    <header className="border-b border-slate-200 bg-white/90 dark:border-slate-800/70 dark:bg-slate-950/80 backdrop-blur sticky top-0 z-50 transition-colors">
      <div className="mx-auto max-w-6xl px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="flex h-5 w-10 items-center rounded-full bg-slate-200 dark:bg-slate-800 p-0.5"
            >
              <span
