...
export const OPERATIONS = {
  ...
  linearConv: {
    id: 'linearConv',
    name: 'Linear Conv',
    fullName: 'Linear Convolution',
    description: 'Convolution of two finite sequences',
    icon: '📐',
    color: 'indigo',
    inputs: 'twoSequences',
    outputs: 'sequence',
  ...
  overlapSave: {
    id: 'overlapSave',
    name: 'Overlap-Save',
    fullName: 'Overlap-Save Method',
    description: 'Block convolution using overlap-save',
    icon: '✂️',
    color: 'orange',
    inputs: 'twoSequences',
    outputs: 'sequence',
  ...
  overlapAdd: {
    id: 'overlapAdd',
    name: 'Overlap-Add',
    fullName: 'Overlap-Add Method',
    description: 'Block convolution using overlap-add',
    icon: '➕',
    color: 'cyan',
    inputs: 'twoSequences',
    outputs: 'sequence',
